...
String direction;
int position;
String potentialDirections[]={"N1","N2","E1","E2","S1","S2","W1","W2"};
...
Scanner myObj = new Scanner(System.in);
  ...
  public void northOne () {
    ...
    System.out.println("You walk upstairs and head into your dorm. There to meet you is your roommate.*** +1 POINT *** \n");
    ...
    System.out.println("Well, that was fun. *UwU*, I think that's all I can do here. Should I go further into my dorm more north or go back downstairs? \n");
    String directionInputTwo = myObj.nextLine();
  }
